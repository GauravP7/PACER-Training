...
if IS_CSO_LOGIN == False:
	...
	courthouse_link_element = 'ecf-test.cacd'
...
class Downloader():
	...
	def __init__(self):
		...
		self.extractor_type_object = ExtractorType()
		...
		if self.extractor_object.extractor_type_id == 1:
			self.extractor_type_object.extractor_type = self.extractor_type_object.DATE_RANGE
		elif self.extractor_object.extractor_type_id == 2:
			self.extractor_type_object.extractor_type = self.extractor_type_object.REFRESH_CASE
		elif self.extractor_object.extractor_type_id == 3:
			self.extractor_type_object.extractor_type = self.extractor_type_object.PACER_IMPORT_CASE
	...
	def set_credentials(self):
		...
		with open('/home/mis/DjangoProject/cso_login/extractor/credentials.json') as credentials_json:
...
>>>>>>> f6d2b65cb6ee16e5818da9c028be39abe54c95dc:cso_login/extractor/pacer_scrape.py
	...
	def login_pacer(self):
		...
		login_page = 'https://' + courthouse_link_element + '.uscourts.gov/cgi-bin/login.pl?logout'
	...
	def get_case_details_page_contents(self):
		...
		query_page_url = 'https://' + courthouse_link_element + '.uscourts.gov/cgi-bin/iquery.pl'
		...
		data_page_url = "https://" + courthouse_link_element + ".uscourts.gov/cgi-bin/iquery.pl?" + required_form_number + "-L_1_0-1"
	...
	def save_all_case_details_page(self, case_details_page_contents):
		...
		case_number_list = []
		file_names_list = []
		case_details_base_link = 'https://' + courthouse_link_element + '.uscourts.gov/cgi-bin/'
		case_count = 0
		is_parsed = 0
		page_path = '/home/mis/DjangoProject/cso_login/extractor/contents'
	...
	def get_page_based_on_case_number(self, case_number):
		...
		pacer_case_id = 0
		DEFAULT = 2
		additional_info_base_url = 'https://' + courthouse_link_element + '.uscourts.gov/cgi-bin'
		...
		docket_page_url = "https://" + courthouse_link_element + ".uscourts.gov/cgi-bin/DktRpt.pl?"

		case_file_name =  case_number.replace(':', '').replace('-', '_')
		docket_page_path = '/home/mis/DjangoProject/cso_login/extractor/contents/case/'
		...
		docket_details_page_url = "https://" + courthouse_link_element + ".uscourts.gov/cgi-bin/DktRpt.pl?" + required_form_number + "-L_1_0-1"
	...
	def save_import_case(self, page_contents, case_number):
		...
		case_file_object = open('/home/mis/DjangoProject/cso_login/extractor/contents/case/' + file_name , 'w+')
	...
	def save_indivisual_cases(self, case_details_page_contents):
		...
		for case_link in case_links_list:
			...
			page_value_json['CASE'] = '/home/mis/DjangoProject/cso_login/extractor/contents/case/' + str(file_name)
			page_value_json = json.dumps(page_value_json)
			self.connection_cursor.execute("SELECT id from courtcase WHERE pacer_case_id = %s", (pacer_case_id,))
	...
	def logout(self):
		...
		logout_page_url = "https://" + courthouse_link_element + ".uscourts.gov/cgi-bin/login.pl?logout"
...
class Parser():
	...
	def parse_case_details_page(self, file_name):
		...
		case_file = open('/home/mis/DjangoProject/cso_login/extractor/contents/case/' + file_name, 'r')
	...
	def get_local_parse_filename(self, case_number):
		file_find_path = '/home/mis/DjangoProject/cso_login/extractor/contents/case'
